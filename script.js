...
/* -----------------------------------
   電停別運賃表（詳細版）
   後免線の電停順に、各電停から他の電停への運賃
----------------------------------- */
const gomenStationOrder = [
  "伊野","伊野駅前","鳴谷","北山","北内","伊野商業前","枝川","中山",
  "八代通","宇治団地前","咥内","宮の奥","朝倉神社前","朝倉駅前","朝倉",
  "曙町","曙町東町","鴨部","鏡川橋","蛍橋","旭町三丁目","旭駅前通",
  "旭町一丁目","上町五丁目","上町四丁目","上町二丁目","上町一丁目",
  "枡形","グランド通","県庁前","高知城前","大橋通","堀詰",
  "はりまや橋","デンテツターミナルビル前","菜園場町","宝永町",
  "知寄町一丁目","知寄町二丁目","知寄町","知寄町三丁目","葛島橋東詰",
  "西高須","県立美術館通","高須","文珠通","介良通","新木","東新木",
  "田辺島通","鹿児","舟戸","北浦","領石通","清和学園前","一条橋",
  "明見橋","長崎","小篭通","篠原","住吉通","東工業前","後免西町",
  "後免中町","後免東町","後免町"
];

const inoStationOrder = [
  "伊野","伊野駅前","鳴谷","北山","北内","伊野商業前","枝川","中山",
  "八代通","宇治団地前","咥内","宮の奥","朝倉神社前","朝倉駅前","朝倉",
  "曙町","曙町東町","鴨部","鏡川橋","蛍橋","旭町三丁目","旭駅前通",
  "旭町一丁目","上町五丁目","上町四丁目","上町二丁目","上町一丁目",
  ...
  "田辺島通","鹿児","舟戸","北浦","領石通","清和学園前","一条橋",
  "明見橋","長崎","小篭通","篠原","住吉通","東工業前","後免西町",
  "後免中町","後免東町","後免町","蓮池町通","高知橋","高知駅前",
  "梅の辻","桟橋通一丁目","桟橋通二丁目","桟橋通三丁目",
  "桟橋通四丁目","桟橋車庫前","桟橋通五丁目"
];
...
function getDetailedFare(direction, fromStation, toStation) {
  const stationOrder = direction === "ino" ? inoStationOrder : gomenStationOrder;
  const fromIdx = stationOrder.indexOf(fromStation);
  const toIdx = stationOrder.indexOf(toStation);
...
function renderDetailedFareTable() {
  const table = document.getElementById('fare-table-detailed');
  const thead = table.querySelector('thead');
  const tbody = table.querySelector('tbody');
  
  const stationOrder = currentFareTab === "ino" ? inoStationOrder : gomenStationOrder;
  
  thead.innerHTML = '';
  const headerRow = document.createElement('tr');
  headerRow.innerHTML = '<th>駅</th>';
  ...
  stationOrder.forEach((fromStation, fromIdx) => {
    const row = document.createElement('tr');
    
    const firstTd = document.createElement('td');
    firstTd.textContent = fromStation;
    row.appendChild(firstTd);
    
    stationOrder.forEach((toStation, toIdx) => {
      const td = document.createElement('td');
      
      if (fromIdx === toIdx) {
        td.textContent = '—';
      } else {
        const fare = getDetailedFare(currentFareTab, fromStation, toStation);
